...
// Awswer: NO Const variables can not be redeclared, this line will throw error.

// Q4: What will happen if you use a variable without declaring it?
// Awswer: It will throw ReferenceError.

// Q5: What is the default value of an uninitialized variable in JavaScript?
// Awswer: Default value is undefined.

// Q6: What are the primitive data types in JavaScript?
// Awswer: There are 7 primitive data types in JavaScript.
// 1. Number
// 2. String
// 3. Boolean
// 4. Undefined
...
// Undefined: A variables that has been declared but not assigned intialized value.

// Q8: Is JavaScript a statically typed or dynamically typed language?
// Answer: Dynamically Type
